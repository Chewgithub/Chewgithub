...
**The Business Problem:** Security teams in public spaces cannot monitor every camera feed simultaneously. Delayed responses to physical altercations lead to greater harm and liability.

**The Solution:** A real-time violence detection pipeline built with **Deep Convolutional Neural Networks** and OpenCV — automatically flagging physical altercations in video footage so human attention is directed where it matters most.

**Tech:** Python · TensorFlow · OpenCV · Deep CNNs

---

### [📈 Change Detection](https://github.com/Chewgithub/change_detection)

Exploring time series analysis, signal processing, and segmentation techniques — the methodological foundation behind reliable anomaly detection in production systems.
